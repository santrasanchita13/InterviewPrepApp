...
public class RevisePresenter<V extends ReviseMvpView> extends BasePresenter<V> implements ReviseMvpPresenter<V> {

    @Inject
    public RevisePresenter(DataManager dataManager,
        ...
        getCompositeDisposable().add(getDataManager()
                ...
                .subscribe(questionList -> {
                    ...
                    if(questionList != null && questionList.size() > 0) {
                        getMvpView().questionsFetched(questionList);
                    }
                    else {
